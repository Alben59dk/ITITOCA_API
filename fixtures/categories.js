  ...
  if (err) {
    ...
    fixtures({
      CategoryModel: [
        ...
        {name: '5 minutes', type: 'TIME', image: 'public/images/categories/five_minutes.svg'},
        ...
        {name: '2 heures', type: 'TIME', image: 'public/images/categories/two_hours.svg'},
        {name: 'Une demi-journée', type: 'TIME', image: 'public/images/categories/half_day.svg'},
        {name: 'Un jour', type: 'TIME', image: 'public/images/categories/one_day.svg'},
        {name: '1 semaine', type: 'TIME', image: 'public/images/categories/one_week.svg'},
